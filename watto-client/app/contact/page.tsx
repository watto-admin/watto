  ...
  return (
    <main className="min-h-screen pt-32 pb-16 px-6 bg-black text-white flex flex-col items-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-4xl md:text-6xl font-bold mb-8 text-center tracking-tighter">Get in Touch</h1>
        ...
        <form className="space-y-6">
            ...
            <button type="submit" className="w-full bg-white text-black font-bold py-4 rounded-lg hover:bg-gray-200 transition-colors text-lg">
                Send Message
            </button>
        </form>
        ...
        <div className="mt-16 text-center border-t border-white/10 pt-12">
            ...
            <a href="mailto:hello@watto.com" className="text-2xl font-bold hover:text-blue-500 transition-colors">hello@watto.com</a>
        </div>
      </div>
    </main>
  );
